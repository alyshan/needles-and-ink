...
<div class="form-group row">
  ...
  <div class="col-xs-10">
    <input class="form-control" type="text" placeholder="Studio Name" id="example-text-input" name="studio-name" value="<?= isset($_POST['new-studio']) ? $_POST['studio-name'] : '' ?>">
...
<div class="form-group row">
  ...
  <div class="col-xs-10">
    <input class="form-control" type="email" placeholder="example@example.com" id="example-email-input" name="studio-email" value="<?= isset($_POST['new-studio']) ? $_POST['studio-email'] : '' ?>">
...
<div class="form-group row">
  ...
  <div class="col-xs-10">
    <input class="form-control" type="text" placeholder="Street Address" id="example-text-input"
     name="street-address" value="<?= isset($_POST['new-studio']) ? $_POST['street-address'] : '' ?>">
...
<div class="form-group row">
  ...
  <div class="col-xs-10">
    <input class="form-control" type="text" placeholder="City" id="example-text-input"
     name="city" value="<?= isset($_POST['new-studio']) ? $_POST['city'] : '' ?>">
...
<div class="form-group row">
  ...
  <div class="col-xs-10">
    <input class="form-control" type="tel" placeholder="(55)-555-5555" id="example-tel-input" name="studio-phone" value="<?= isset($_POST['new-studio']) ? $_POST['studio-phone'] : '' ?>">
    <?= isset($studioPhoneMessage) ?  $studioPhoneMessage : ''?>
  </div>
  </div>
 <div class="form-group">
    <label for="exampleTextarea">About the Studio</label>
    <textarea class="form-control" id="exampleTextarea" rows="5" class="col-xs-2" name="desc" value="<?= isset($_POST['new-studio']) ? $_POST['desc'] : '' ?>"></textarea> 
